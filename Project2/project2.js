...
class MeshDrawer {
    ...
    draw(trans) {
        ...
        gl.uniform3fv(this.viewPosLoc, [0, 0, 5]); // Fixed camera position
    ...
    setTexture(img, isSecondTexture = false) {
        ...
        if (isPowerOf2(img.width) && isPowerOf2(img.height)) {
             ...
             */
                         // Horizontal texture wrapping handling for coordinates beyond normalized range
                         gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    
                         // Vertical textıoure wrapping handling for coordinates beyond normalized range
                         gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
                         
                         // Define texture behavior when viewed from a distance
                         gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
                         
                         // Define texture behavior when viewed up close
    ...
    setBlendFactor(value) {
        ...
        gl.uniform1f(this.blendFactorLoc, normalizedValue);
    }
...
const meshFS = `
    ...
    void main() {
        ...
        vec4 tex1Color = texture2D(tex, v_texCoord);
        ...
        if(showTex && enableLighting) {
            ...
            gl_FragColor = finalColor * lightIntensity + vec4(1.0) * spec * specular;
        }
        else if(showTex) {
